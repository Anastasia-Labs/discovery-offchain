...
export const buildLiquidityScripts = (
  ...
  const collectFoldValidator = applyParamsToScript(
    config.unapplied.collectFoldValidator,
    [
  ...
  const collectFoldPolicy = applyParamsToScript(
    config.unapplied.collectFoldPolicy,
    [
      new Constr(0, [
        lucid.utils.mintingPolicyToId(liquidityMintingPolicy),
  ...
  const projectAddress = fromAddressToData(
    config.rewardFoldValidator.projectAddr,
  );
  ...
  const rewardFoldPolicy = applyParamsToScript(
    config.unapplied.distributionFoldPolicy,
    [
      new Constr(0, [
        lucid.utils.mintingPolicyToId(liquidityMintingPolicy), // nodeCS
  ...
  const liquidityValidator = applyParamsToScript(
    ...
    [
      new Constr(0, [
        ...
        new Constr(0, [
          new Constr(1, [
            lucid.utils.validatorToScriptHash(collectStakeValidator),
          ]),
        ]), // PStakingCredential
        new Constr(0, [
          new Constr(1, [
  ...
  return {
    ...
    data: {
      ...
      proxyTokenHolderValidator: proxyValidatorScript,
    },
  };
};
